...
import { Plus, Search, Edit2, Trash2, Mail, Phone, ChevronUp, ChevronDown, ChevronsUpDown } from 'lucide-react';
    ...
    return (
        <motion.div initial={{ opacity: 0 }} animate={{ opacity: 1 }}>
            <div className="page-header flex items-center justify-between">
                <h1 className="page-title text-[18px] font-bold mt-1">{t.common.totalCustomers}</h1>
                ...
                <table className="min-w-full divide-y divide-gray-200">
                    <thead className="bg-[#27AA83] text-xs uppercase text-white border-b border-[#27AA83] h-[38px]">
                        <tr>
                            {['name', 'phone', 'email', 'address', 'totalOrders', 'totalPurchase'].map((col) => (
                                ...
                                >
                                    <div className="flex items-center gap-1">
                                        {col === 'name' && t.common.name}
                                        {col === 'phone' && t.common.phone}
                                        {col === 'email' && t.common.email}
                                        {col === 'address' && t.common.address}
                                        {col === 'totalOrders' && t.common.orders}
                                        {col === 'totalPurchase' && t.common.totalSpent}
                            ...
                            <th className="py-3 px-3 text-left font-semibold">{t.common.actions}</th>
                        </tr>
                    </thead>
            ...
            <Dialog open={showDialog} onOpenChange={setShowDialog}>
                <DialogContent className="sm:max-w-md w-full rounded-lg p-6 bg-white shadow-lg">
                    <DialogHeader className="pb-2 border-b border-gray-200">
                        <DialogTitle className="text-lg font-semibold text-gray-900">{editing ? t.common.edit : t.common.add} {t.common.customer}</DialogTitle>
                    </DialogHeader>
